...
SET PGDATA_OLD=D:\PostgresData_9.5
SET PGDATA_NEW=D:\PostgresData_9.6
SET PGBIN_OLD=C:\Program Files\PostgresPro\9.5\bin
SET PGBIN_NEW=C:\Program Files\PostgresPro\9.6\bin
...
REM останавливаем 9.6
net stop postgrespro-X64-9.6
if %ERRORLEVEL% == 0 goto initdb
if %ERRORLEVEL% == 2 goto initdb
echo ===========================================
echo Service "postgrespro-X64-9.6" failed to stop
echo ===========================================
goto endscript
...
echo ===========================================
echo Init cluster postgresql 9.6 failed
echo ===========================================
goto endscript
...
if %ERRORLEVEL% == 0 goto start_next
echo ===========================================
...
net start postgrespro-X64-9.6
if %ERRORLEVEL% == 0 goto endprocess
echo ===========================================
echo Service "postgrespro-X64-9.6" failed to start
echo ===========================================
goto endscript
...
REM "%PGBIN_NEW%\psql.exe" -h localhost -U "postgres" -t -A -f "upgrade_dump_stat_new.sql"
echo ==========================================================================================
echo =========                                                                   ==============
...
REM "%PGBIN_NEW%\psql.exe" -h localhost -U "postgres" -d sparkmes -c "select public.job_prewarm();"
echo =========                                                                   ==============
echo ==========================================================================================
